...
class Musics {
    ...
    constructor() {
        this.songs = (function(){
            ...
            var music_data=['English ver - 活动小丑.mp3', 'GALA - 追梦赤子心.mp3', '东风破 - 周杰伦.mp3', '五月天 - 如烟.mp3', '伍佰 - 突然的自我 (Live).mp3', '伍佰&China Blue - 挪威的森林.mp3', '優しい詩。.mp3', '剑三 - 杀伐.mp3', '又黑我唐家堡.mp3', '双笙 - 泸沽寻梦.mp3', '周杰伦 - 七里香 (Live).mp3', '周杰伦 - 东风破 (Live).m4a', '周杰伦 - 晴天.mp3', '如我西沉.mp3', '孙燕姿 - 我怀念的 (Live).mp3', '孙燕姿 - 遇见.mp3', '孙燕姿-天黑黑.mp3', '小さな恋のうた.mp3', '尧十三 - 瞎子(贵州话).mp3', '开始懂了.mp3', '张靓颖 - 画心.m4a', '徐誉滕 - 等一分钟.mp3', '我的一个黄牛朋友.mp3', '新裤子 - 假如生活欺骗了你.m4a', '是谁在长歌.mp3', '李宗盛 - 山丘 (Live).m4a', '李宗盛 - 我终于失去了你 (Live).m4a', '李宗盛 - 漂洋过海来看你.mp3', '林宥嘉 - 成全.mp3', '梁静茹-情歌.mp3', '棠梨煎雪.mp3', '牵丝戏.mp3', '罗大佑 - 童年.mp3', '羊屁股.mp3', '老涵本人 - 南下（翻自 徐海俏） .mp3', '老琴爹.mp3', '腐草为萤.mp3', '莫文蔚-盛夏的果实.mp3', '董贞 - 醉梦仙霖 (Live版).mp3', '许嵩 - 南山忆.mp3', '许嵩 - 如约而至.mp3', '许嵩 - 摄影艺术.mp3', '许嵩 - 最佳歌手.mp3', '许嵩 - 玫瑰花的葬礼.mp3', '许嵩 - 艺术家们.mp3', '许嵩 - 雅俗共赏.mp3', '许嵩 - 雨幕.mp3', '谢安琪 - 钟无艳.mp3', '路绮欧 - 习惯.mp3', '路绮欧 - 发现.mp3', '钟无艳 - 谢安琪.mp3', '陈奕迅 - 你的背包.mp3', '陈奕迅 - 爱情转移(国).mp3', '陈奕迅 - 阴天快乐.mp3', '青释 - 棠红棣雪.mp3', '风花雪月.mp3', '黄诗佳 - 樱花草.mp3']
            var song_data = [];
